...
const uint8_t DISPLAY_LABEL1_DISPLAY_POSITION = 28;
FLASH_STRING(DISPLAY_LABEL1_STRING,"tester");

FLASH_STRING(FRAME0_NAME,"test1");
FLASH_STRING(FRAME1_NAME,"test2");
const _FLASH_STRING FRAME_NAME_ARRAY[FRAME_COUNT] =
  {
    FRAME0_NAME,
    FRAME1_NAME,
  };

// const uint8_t DISPLAY_VAR1_DISPLAY_POSITION = 51;
// const uint8_t DISPLAY_VAR1_DEFAULT_VALUE = 77;

// const uint8_t INTERACTIVE_VAR1_DISPLAY_POSITION = 71;
// const uint8_t INTERACTIVE_VAR1_DEFAULT_VALUE = 11;
// const uint8_t INTERACTIVE_VAR1_MIN = 7;
// const uint8_t INTERACTIVE_VAR1_MAX = 38;

// const uint8_t INTERACTIVE_VAR2_DISPLAY_POSITION = 71;
...
void setup()
{
  ...
  // Frame 0
  int frame = 0;
  display_label1.addToFrame(frame);
